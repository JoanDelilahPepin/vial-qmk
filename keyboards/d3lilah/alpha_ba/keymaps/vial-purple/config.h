...
// Haptic feedback - DRV2605L Configuration (re-enabled for dual haptic system)
...
// Default haptic settings - disable automatic haptic on all keypresses
#define NO_HAPTIC_MOD               // Disable haptic feedback on modifier keys
#define NO_HAPTIC_ALPHA             // Disable haptic feedback on alpha keys
#define NO_HAPTIC_PUNCTUATION       // Disable haptic feedback on punctuation
#define NO_HAPTIC_NAV               // Disable haptic feedback on navigation keys
#define NO_HAPTIC_NUMERIC           // Disable haptic feedback on number keys

// =============================================================================
// CUSTOM SOLENOID CONFIGURATION (not using QMK driver - custom implementation for dual haptic)
// =============================================================================
#define SOLENOID_PIN GP14  // Native RP2040 GPIO pin 14 (purple PCB revision)
#define SOLENOID_ENABLE_PIN GP15  // GP15 is now the enable pin (high=enabled, low=disabled)

// Custom solenoid timing configuration
#define SOLENOID_DWELL_DEFAULT 12  // Dwell time in milliseconds (default)
#define SOLENOID_DWELL_MIN 4
#define SOLENOID_DWELL_MAX 30
#define SOLENOID_DWELL_STEP 2      // Step size for dwell adjustment
#define SOLENOID_DEBOUNCE_MS 20    // Minimum time between solenoid fires (cooldown)
#define SOLENOID_ENABLED_DEFAULT true

// EEPROM storage size for custom solenoid configuration
