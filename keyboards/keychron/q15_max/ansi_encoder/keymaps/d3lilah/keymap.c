...
// Custom keycodes for writing macros - using QK_KB_0 base for Vial compatibility
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_FN3] = LAYOUT_ansi_66(
        ...
        _______,  KC_AC_TOGG,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,
